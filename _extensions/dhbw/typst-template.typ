...
#let project(
  ...
  align(center)[
    ...
    \ \ #emph(text(12pt, weight: 200, "Eingereicht im Rahmen"))
    \ #emph(text(12pt, weight: 200, "des Dualen Studiums in"))
  ...
  align(center)[
    ...
    \ #text(12pt, smallcaps(guide.affiliation+","))
  ...
  // Main body.
  set par(justify: true)
  set heading(numbering: headingStyle)
